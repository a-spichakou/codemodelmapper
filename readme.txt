...
reflection-based mappers (they are usially force you to create mapping rules in Excel
or plain text/XML files) is problems on development stage. You have to debugyou rules
on runtime. "Misprint" mistakes will occur after deply/test process. It is not problem
for small application. But takes long time for big enterprise application.
