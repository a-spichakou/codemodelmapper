...
public class ComplexMapperSourceGeneratorTest extends TestCase{
	...
	public void testGenerateMapperComplex() {
		final MapperSourceGenerator generator = new MapperSourceGenerator(TEST_PACKAGE + "GenerateMapperComplex", SourceObject.class, TargetObject.class);
